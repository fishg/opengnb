...
void gnb_config_lite(gnb_core_t *gnb_core){
    ...
    if ( NULL == gnb_conf_ext_lite.node_route_string ) {
        gnb_conf_ext_lite.node_route_string = "1001|10.1.0.1|255.255.0.0,1002|10.1.0.2|255.255.0.0,1003|10.1.0.3|255.255.0.0,1004|10.1.0.4|255.255.0.0,1005|10.1.0.5|255.255.0.0,1006|10.1.0.6|255.255.0.0,1007|10.1.0.7|255.255.0.0,1008|10.1.0.8|255.255.0.0,1009|10.1.0.9|255.255.0.0,10010|10.1.0.10|255.255.0.0";
    }
